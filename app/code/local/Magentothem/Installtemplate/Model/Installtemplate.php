...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
		...
		Mage::getConfig()->saveConfig('design/package/name', 'sahara_digital', $scope, $store);
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_sahara_digital12', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'sahara_digital12', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_sahara_digital12', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'sahara_digital12', 'default', 0);
